...
{
  {
    ...
    using DenseIndexSet = std::ranges::iota_view<int, int>;
    auto denseIndices = DenseIndexSet(0, data.size());

    using ArrayView = Dune::Imp::IndexedArrayView<double*, DenseIndexSet>;
